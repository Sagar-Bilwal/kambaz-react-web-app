...
export default function Profile() {
  return (
    <div id="wd-profile-screen">
      <h1>Profile</h1>
      <Form.Control defaultValue="alice" placeholder="username" className="wd-username mb-2" id = "wd-username"/>
      <Form.Control defaultValue="123"   placeholder="password" type="password" id = "wd-password"
      ...
      <Link to="/Kambaz/Account/Signin" id = "wd-btn-signout-add" className="btn btn-danger w-100 mb-2">Sign out</Link>
    </div>
);}
